        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2 justify-end w-full md:w-auto">
                ...
                @if(in_array($nota->status, ['criada', 'erro', 'rascunho']))
                    ...
                    <a href="{{ route('notas.edit', $nota->id) }}" class="flex items-center bg-yellow-500 text-white px-4 py-2 rounded-md hover:bg-yellow-600 shadow font-medium transition">
