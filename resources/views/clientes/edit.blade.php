    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <form action="{{ route('clientes.update', $cliente->id) }}" method="POST" class="space-y-6"
                  x-data="{
                      // Inicializa com dados do PHP
                      docType: '{{ strlen($cliente->cnpj) > 11 ? 'cnpj' : 'cpf' }}',
                      cep: '{{ $cliente->cep }}',
                ...
                <div class="flex justify-end pt-4 border-t border-gray-100 mt-6">
                    ...
                    <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 font-bold shadow-sm">
                        Atualizar Cliente
                    </button>
                </div>
            </form>
